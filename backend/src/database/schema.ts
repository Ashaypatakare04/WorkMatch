// WorkMatch AI Relational Database Schema DDL for SQLite
...
CREATE TABLE IF NOT EXISTS job_analyses (
    ...
    technical_complexity TEXT NOT NULL DEFAULT 'Low',
    estimated_hours REAL NOT NULL DEFAULT 2.0,
    step_count INTEGER NOT NULL DEFAULT 1,
    communication_level TEXT NOT NULL DEFAULT 'Low',
    deadline_pressure TEXT NOT NULL DEFAULT 'Low',
    budget_quality TEXT NOT NULL DEFAULT 'Fair',
...
CREATE TABLE IF NOT EXISTS automation_settings (
    id TEXT PRIMARY KEY,
    user_id TEXT UNIQUE NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    application_mode TEXT NOT NULL DEFAULT 'MANUAL',
